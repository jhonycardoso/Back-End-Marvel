...
public class Serie implements Serializable{
	...
	public Serie(Long id, String title, String description, Date startDate, Date endDate, List<Character> character,
			List<Comic> comic, List<Storie> storie, List<Event> event) {
		super();
		this.id = id;
		this.title = title;
	...
	public String toString() {
		final int maxLen = 10;
		return "Serie [id=" + id + ", title=" + title + ", description=" + description + ", startDate=" + startDate
